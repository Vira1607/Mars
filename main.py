...
paces = int(input('Введите число шагов: '))

for i in range (paces):
  command = input('Марсоход находится на позиции ' + str(position_i) + ', ' + str(position_j) + ', введите команду: ')

  if (0 < position_i < 15) and ((command == 'A') or (command == 'D')):
    if (command == 'A'):
      position_i -= 1
    else:
      position_i += 1

  if (0 < position_j < 20) and ((command == 'W') or (command == 'S')):
    if (command == 'W'):
      position_j += 1
    else:
      position_j -= 1

print('Марсоход находится на позиции ' + str(position_i) + ', ' + str(position_j))
